...
from fridgeapp.services.service.product import ProductService
...
class IngredientSerializer(serializers.ModelSerializer):
    ...
    product = serializers.CharField(source="product.name", default="", max_length=100)

    class Meta:
        model = Ingredient
        fields = ("ingredient_id", "quantity", "measure", "product", "author")
